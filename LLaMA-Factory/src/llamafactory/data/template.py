...
register_template(
    ...
    format_assistant=StringFormatter(slots=["{{content}}</s>"]),
    default_system="// Implement the Verilog module based on the following description. Assume that signals are positive clock/clk triggered unless otherwise stated.",
    stop_words=["</s>"],
)
